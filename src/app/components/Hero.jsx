    ...
    <div className='h-auto' style={{
        ...
        <Wrapper className={'py-30 grid md:grid-cols-2 grid-cols-1 items-center'}>
            <div className="flex flex-col space-y-5">
                ...
                <p className='text-white text-xl split-word'>For the first time ever, First Church will offer SIX Christmas Eve services! We're looking forward to these two days of celebrating the Newborn King with you and your guests. Click the link to plan your Christmas!</p>
                <PlayAnimation />
            </div>
